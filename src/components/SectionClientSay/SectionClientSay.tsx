...
const DEMO_DATA = [
  {
    ...
    content:
      "This place is exactly like the picture posted on Ticketshala. Great service, we had a great stay!",
  },
  {
    id: 2,
...
const SectionClientSay: FC<SectionClientSayProps> = ({ className = "" }) => {
  ...
  return (
    ...
    >
      <Heading desc="Let's see what people think of Ticketshala" isCenter>
